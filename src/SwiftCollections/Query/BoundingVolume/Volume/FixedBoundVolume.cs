...
public struct FixedBoundVolume : IBoundVolume
{
    ...
    /// <summary>
    /// Initializes a new instance of the FixedBoundVolume class with the specified minimum and maximum coordinates.
    /// </summary>
    /// <param name="min">The minimum corner of the volume, representing the lowest coordinate values along each axis.</param>
    /// <param name="max">The maximum corner of the volume, representing the highest coordinate values along each axis.</param>
    ...
    {
        if (other is not FixedBoundVolume otherBV)
